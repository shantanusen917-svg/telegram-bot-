...
# ===== CONFIGURATION =====
BOT_TOKEN = "8024858447:AAGJjwBm587bn84I68b1_2ad6h173Qysuec"  # তোমার BotFather Token
ADMIN_ID = 6345288802                                         # Admin-এর Telegram ID
ADMIN_USERNAME = "@ajahajahh"                                 # Admin-এর Telegram Username
PAYEER_UID = "P1123839604"                                    # তোমার Payeer Account ID
CSV_FILE = "exchange_requests.csv"                             # CSV ফাইলের নাম (ঐচ্ছিক)
current_rate = 110                                             # প্রাথমিক USD → BDT রেট
